...
//     return
// }
// console.log(`Conteúdo do qrquivo: ${dado}`);
// });
...
function executar() {
  fs.mkdir('C:/Users/Windows10/Documents/app', { recursive: true }, (erro) => {
    if (erro) {
      console.error(`Erro ao criar diretório: ${erro}`);
      return;
    };
  ...
  fs.writeFile('C:/Users/Windows10/Documents/app/arquivo.txt', 'Hello!', 'utf-8', (erro) => {
    if (erro) {
      console.error(`Erro ao criar arquivo: ${erro}`);
      return;
    };
    ...
    fs.readFile('C:/Users/Windows10/Documents/app/arquivo.txt', 'utf-8', (erro, dado) => {
      if (erro) {
        console.error(`Erro ao ler arquivo: ${erro}`);
        return;
      }
